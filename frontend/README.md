...
Without `REACT_APP_CLERK_PUBLISHABLE_KEY`, the frontend builds successfully and displays a configuration screen instead of failing at runtime. Add the value in Vercel and redeploy when you are ready to enable sign-in.
## Installation
